...
public class Movie implements Parcelable {
    ...
    private String language; //spinner
    ...
    public Movie(String title, Double budget, Date release, Integer duration, GenreEnum genre,
                 ParentalGuidanceEnum pGuidance, Float rating, Boolean watched, String posterUrl, String language) {
        this.title = title;
        this.budget = budget;
        this.release = release;
        this.duration = duration;
